...
client.on("message", async message => {
  ...
  if (message.author.bot) return;
  try {
    if (message.content === prefix + "djs-v11-general-1") {
      var args = message.content.split(" ");
      if (cooldown.has(message.author.id)) {
        message.channel.send(
          new MessageEmbed()
        ...
        message.author
          .send(
            new MessageEmbed()
              .setColor("00e8ff")
              .setDescription(
                `**${client.emotes.nodejs} Description : avatar code\n${client.emotes.list} Code : \`https://pastebin.com/XWBtQb32\`**`
              )
          )
          .then(msg => {
            message.react(`${client.emotes.success}`);
...
client.on("message", async message => {
  ...
  if (message.author.bot) return;
  try {
    if (message.content === prefix + "djs-v11-general-2") {
      var args = message.content.split(" ");
      if (cooldown.has(message.author.id)) {
        message.channel.send(
          new MessageEmbed()
        ...
        message.author
          .send(
            new MessageEmbed()
              .setColor("00e8ff")
              .setDescription(
                `**${client.emotes.nodejs} Description : bot info code\n${client.emotes.list} Code : \`https://pastebin.com/ujTgmhsy\`**`
              )
          )
          .then(msg => {
            message.react(`${client.emotes.success}`);
...
client.on("message", async message => {
  ...
  if (message.author.bot) return;
  try {
    if (message.content === prefix + "djs-v11-general-3") {
      var args = message.content.split(" ");
      if (cooldown.has(message.author.id)) {
        message.channel.send(
          new MessageEmbed()
        ...
        message.author
          .send(
            new MessageEmbed()
              .setColor("00e8ff")
              .setDescription(
                `**${client.emotes.nodejs} Description : credits and profile code\n${client.emotes.list} Code : \`https://pastebin.com/W97ZXFt0\`**`
              )
          )
          .then(msg => {
            message.react(`${client.emotes.success}`);
...
client.on("message", async message => {
  ...
  if (message.author.bot) return;
  try {
    if (message.content === prefix + "djs-v11-general-4") {
      var args = message.content.split(" ");
      if (cooldown.has(message.author.id)) {
        message.channel.send(
          new MessageEmbed()
        ...
        message.author
          .send(
            new MessageEmbed()
              .setColor("00e8ff")
              .setDescription(
                `**${client.emotes.nodejs} Description : server info code\n${client.emotes.list} Code : \`https://pastebin.com/UUNbcGN6\`**`
              )
          )
          .then(msg => {
            message.react(`${client.emotes.success}`);
...
client.on("message", async message => {
  ...
  if (message.author.bot) return;
  try {
    if (message.content === prefix + "djs-v11-general-5") {
      var args = message.content.split(" ");
      if (cooldown.has(message.author.id)) {
        message.channel.send(
          new MessageEmbed()
        ...
        message.author
          .send(
            new MessageEmbed()
              .setColor("00e8ff")
              .setDescription(
                `**${client.emotes.nodejs} Description : say and embed say code\n${client.emotes.list} Code : \`https://pastebin.com/4mghqgnu\`**`
              )
          )
          .then(msg => {
            message.react(`${client.emotes.success}`);
...
client.on("message", async message => {
  ...
  if (message.author.bot) return;
  try {
    if (message.content === prefix + "djs-v11-general-6") {
      var args = message.content.split(" ");
      if (cooldown.has(message.author.id)) {
        message.channel.send(
          new MessageEmbed()
        ...
        message.author
          .send(
            new MessageEmbed()
              .setColor("00e8ff")
              .setDescription(
                `**${client.emotes.nodejs} Description : ping code\n${client.emotes.list} Code : \`https://pastebin.com/QAUQzpe7\`**`
              )
          )
          .then(msg => {
            message.react(`${client.emotes.success}`);
...
client.on("message", async message => {
  ...
  if (message.author.bot) return;
  try {
    if (message.content === prefix + "djs-v11-general-7") {
      var args = message.content.split(" ");
      if (cooldown.has(message.author.id)) {
        message.channel.send(
          new MessageEmbed()
        ...
        message.author
          .send(
            new MessageEmbed()
              .setColor("00e8ff")
              .setDescription(
                `**${client.emotes.nodejs} Description : giveaway code\n${client.emotes.list} Code : \`https://pastebin.com/7R8DcaFT\`**`
              )
          )
          .then(msg => {
            message.react(`${client.emotes.success}`);
...
client.on("message", async message => {
  ...
  if (message.author.bot) return;
  try {
    if (message.content === prefix + "djs-v11-general-8") {
      var args = message.content.split(" ");
      if (cooldown.has(message.author.id)) {
        message.channel.send(
          new MessageEmbed()
        ...
        message.author
          .send(
            new MessageEmbed()
              .setColor("00e8ff")
              .setDescription(
                `**${client.emotes.nodejs} Description : roles code\n${client.emotes.list} Code : \`https://pastebin.com/e04QPAmV\`**`
              )
          )
          .then(msg => {
            message.react(`${client.emotes.success}`);
...
client.on("message", async message => {
  ...
  if (message.author.bot) return;
  try {
    if (message.content === prefix + "djs-v11-general-9") {
      var args = message.content.split(" ");
      if (cooldown.has(message.author.id)) {
        message.channel.send(
          new MessageEmbed()
        ...
        message.author
          .send(
            new MessageEmbed()
              .setColor("00e8ff")
              .setDescription(
                `**${client.emotes.nodejs} Description : temp voice channel code\n${client.emotes.list} Code : \`https://pastebin.com/CKkasi6e\`**`
              )
          )
          .then(msg => {
            message.react(`${client.emotes.success}`);
...
client.on("message", async message => {
  ...
  if (message.author.bot) return;
  try {
    if (message.content === prefix + "djs-v11-general-10") {
      var args = message.content.split(" ");
      if (cooldown.has(message.author.id)) {
        message.channel.send(
          new MessageEmbed()
        ...
        message.author
          .send(
            new MessageEmbed()
              .setColor("00e8ff")
              .setDescription(
                `**${client.emotes.nodejs} Description : user code\n${client.emotes.list} Code : \`https://pastebin.com/SwdYagWJ\`**`
              )
          )
          .then(msg => {
            message.react(`${client.emotes.success}`);
...
client.on("message", async message => {
  ...
  if (message.author.bot) return;
  try {
    if (message.content === prefix + "djs-v11-general-11") {
      var args = message.content.split(" ");
      if (cooldown.has(message.author.id)) {
        message.channel.send(
          new MessageEmbed()
        ...
        message.author
          .send(
            new MessageEmbed()
              .setColor("00e8ff")
              .setDescription(
                `**${client.emotes.nodejs} Description : auto respose maker\n${client.emotes.list} Code : \`https://pastebin.com/u6URvDWi\`**`
              )
          )
          .then(msg => {
            message.react(`${client.emotes.success}`);
...
client.on("message", async message => {
  ...
  if (message.author.bot) return;
  try {
    if (message.content === prefix + "djs-v11-general-12") {
      var args = message.content.split(" ");
      if (cooldown.has(message.author.id)) {
        message.channel.send(
          new MessageEmbed()
        ...
        message.author
          .send(
            new MessageEmbed()
              .setColor("00e8ff")
              .setDescription(
                `**${client.emotes.nodejs} Description : role code\n${client.emotes.list} Code : \`https://pastebin.com/RQ7ZhgBw\`**`
              )
          )
          .then(msg => {
            message.react(`${client.emotes.success}`);
...
client.on("message", async message => {
  ...
  if (message.author.bot) return;
  try {
    if (message.content === prefix + "djs-v11-general-13") {
      var args = message.content.split(" ");
      if (cooldown.has(message.author.id)) {
        message.channel.send(
          new MessageEmbed()
        ...
        message.author
          .send(
            new MessageEmbed()
              .setColor("00e8ff")
              .setDescription(
                `**${client.emotes.nodejs} Description : bots count code\n${client.emotes.list} Code : \`https://pastebin.com/pvhRkYc4\`**`
              )
          )
          .then(msg => {
            message.react(`${client.emotes.success}`);
...
client.on("message", async message => {
  ...
  var args = message.content.split(" ");
  try {
    if (message.content === prefix + "djs-v11-admin-1") {
      if (cooldown.has(message.author.id)) {
        message.channel.send(
          new MessageEmbed()
            .setColor("00e8ff")
        ...
        message.author
          .send(
            new MessageEmbed().setColor("00e8ff").setDescription(
              `**${client.emotes.nodejs} Description : clear code
    ${client.emotes.list} Code : \`https://pastebin.com/565iVkFf\`**`
            )
          )
          .then(msg => {
            message.react(`${client.emotes.success}`);
...
client.on("message", async message => {
  ...
  if (message.author.bot) return;
  try {
    if (message.content === prefix + "djs-v11-admin-2") {
      if (cooldown.has(message.author.id)) {
        message.channel.send(
          new MessageEmbed()
            .setColor("00e8ff")
        ...
        message.author
          .send(
            new MessageEmbed().setColor("00e8ff").setDescription(
              `**${client.emotes.nodejs} Description : lock & unlock code
    ${client.emotes.list} Code : \`https://pastebin.com/qzk7N53Z\`**`
            )
          )
          .then(msg => {
            message.react(`${client.emotes.success}`);
...
client.on("message", async message => {
  ...
  if (message.author.bot) return;
  try {
    if (message.content === prefix + "djs-v11-admin-3") {
      if (cooldown.has(message.author.id)) {
        message.channel.send(
          new MessageEmbed()
            .setColor("00e8ff")
    ...
    ${client.emotes.list} Code : \`https://pastebin.com/QdN4wDs2\`**`)
          )
          .then(msg => {
            message.react(`${client.emotes.success}`);
          })
...
client.on("message", async message => {
  ...
  if (message.author.bot) return;
  try {
    if (message.content === prefix + "djs-v11-admin-4") {
      if (cooldown.has(message.author.id)) {
        message.channel.send(
          new MessageEmbed()
            .setColor("00e8ff")
    ...
    ${client.emotes.list} Code : \`https://pastebin.com/kTRDBY1p\`**`)
          )
          .then(msg => {
            message.react(`${client.emotes.success}`);
          })
...
client.on("message", async message => {
  ...
  if (message.author.bot) return;
  try {
    if (message.content === prefix + "djs-v11-admin-5") {
      if (cooldown.has(message.author.id)) {
        message.channel.send(
          new MessageEmbed()
            .setColor("00e8ff")
        ...
        message.author
          .send(
            new MessageEmbed().setColor("00e8ff")
              .setDescription(`**${client.emotes.nodejs} Description : show and hide code
    ${client.emotes.list} Code : \`https://pastebin.com/qQjHjvER\`**`)
          )
          .then(msg => {
            message.react(`${client.emotes.success}`);
          })
...
client.on("message", async message => {
  ...
  if (message.author.bot) return;
  try {
    if (message.content === prefix + "djs-v11-admin-6") {
      if (cooldown.has(message.author.id)) {
        message.channel.send(
          new MessageEmbed()
            .setColor("00e8ff")
    ...
    ${client.emotes.list} Code : \`https://pastebin.com/Xz5Fw7Si\`**`)
          )
          .then(msg => {
            message.react(`${client.emotes.success}`);
          })
...
client.on("message", async message => {
  ...
  if (message.author.bot) return;
  try {
    if (message.content === prefix + "djs-v11-admin-7") {
      if (cooldown.has(message.author.id)) {
        message.channel.send(
          new MessageEmbed()
            .setColor("00e8ff")
...
client.on("message", async message => {
  ...
  if (message.author.bot) return;
  try {
    if (message.content === prefix + "djs-v11-admin-8") {
      if (cooldown.has(message.author.id)) {
        message.channel.send(
          new MessageEmbed()
            .setColor("00e8ff")
    ...
    ${client.emotes.list} Code : \`https://pastebin.com/ee5dEkKW\`**`)
          )
          .then(msg => {
            message.react(`${client.emotes.success}`);
          })
...
client.on("message", async message => {
  ...
  if (message.author.bot) return;
  try {
    if (message.content === prefix + "djs-v11-admin-9") {
      if (cooldown.has(message.author.id)) {
        message.channel.send(
          new MessageEmbed()
            .setColor("00e8ff")
    ...
    ${client.emotes.list} Code : \`https://pastebin.com/G6nPbiP7\`**`)
          )
          .then(msg => {
            message.react(`${client.emotes.success}`);
          })
...
client.on("message", async message => {
  ...
  if (message.author.bot) return;
  try {
    if (message.content === prefix + "djs-v11-admin-10") {
      if (cooldown.has(message.author.id)) {
        message.channel.send(
          new MessageEmbed()
            .setColor("00e8ff")
        ...
        message.author
          .send(
            new MessageEmbed().setColor("00e8ff")
              .setDescription(`**${client.emotes.nodejs} Description : black list code
    ${client.emotes.list} Code : \`https://pastebin.com/zfqX3ZVe\`**`)
          )
          .then(msg => {
            message.react(`${client.emotes.success}`);
          })
...
client.on("message", async message => {
  ...
  if (message.author.bot) return;
  try {
    if (message.content === prefix + "djs-v11-admin-11") {
      if (cooldown.has(message.author.id)) {
        message.channel.send(
          new MessageEmbed()
            .setColor("00e8ff")
        ...
        message.author
          .send(
            new MessageEmbed().setColor("00e8ff").setDescription(
              `**  ${client.emotes.nodejs} Description : Auto role code
    ${client.emotes.list} Code : \`https://pastebin.com/KSd1LNh7\`**`
            )
          )
          .then(msg => {
            message.react(`${client.emotes.success}`);
